...
<body>
<table width="1520" border="0" cellpadding="10" class="titlelogo">
    <tr>
        ...
        <td height="230">
            ...
            <table width="320" border="0">
                <tr>
                    ...
                    <td width="65"><input name="login" type="submit" width="80" height="40" onSubmit="return sendlogin()" value="注册"/></td>
